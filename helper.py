    ...
    def make_folders(self):
        ...
        if self.params.log:
            ...
            with open('saved_models/runs.html', 'a') as f:
                f.writelines([f'<div><a href="https://github.com/15neele/'
            ...
            log.error(
                f'LINK: <a href="https://github.com/15neele/backdoors/tree/'
                f'{self.params.commit}">https://github.com/15neele/backdoors'
